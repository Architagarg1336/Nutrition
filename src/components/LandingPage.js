...
export const TypewriterEffect = ({ words, className, cursorClassName }) => {
  ...
  return (
    <div className={cn("typewriter-container text-2xl sm:text-4xl md:text-6xl lg:text-7xl font-bold text-center", className)}>
      {renderWords()}
      <motion.span
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
    ...
    <div className="landing-page">
      <div className="content">
        <div className="text-section">
          <TypewriterEffect words={words} className="text-lg" cursorClassName="bg-blue-500" />
